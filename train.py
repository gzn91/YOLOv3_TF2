...
flags.DEFINE_string('train_dir', 'records', 'Directory with the training data.')
...
def train(argv):
    ...
    model = YOLOv3(img_shape=FLAGS.img_shape, ncls=FLAGS.ncls, use_spp=True, use_pretrained_weights=True)
